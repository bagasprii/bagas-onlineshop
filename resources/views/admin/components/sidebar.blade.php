<aside
    class="sidebar navbar navbar-expand-lg bg-dark flex-shrink-0 d-flex flex-column flex-shrink-0 p-3 gap-4 align-content-lg-center mx-2 my-5 rounded">
    <h5 class="navbar fs-2 text-white ">Bagas Online Shop</h5>
